...
const LINKS = {
  ...
  erlog: "https://tobysauze.github.io/ER-Log/index.html",
  worklist: "pages/daily-work-list.html",
  shopping: "pages/shopping-list.html",
  ...
  suggestion: "https://mj2-suggestion-box-production.up.railway.app",
};
...
function applyLinks() {
  const map = [
    ...
    ["link-erlog", LINKS.erlog],
    ["link-worklist", LINKS.worklist],
    ["link-shopping", LINKS.shopping],
    ["link-ptw", LINKS.ptw],
    ...
    ["ring-erlog", LINKS.erlog],
    ["ring-worklist", LINKS.worklist],
    ["ring-shopping", LINKS.shopping],
    ["ring-ptw", LINKS.ptw],
